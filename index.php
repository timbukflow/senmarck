...
<body>
    <nav>
        <img src="img/senmarck-energie-logo.svg" alt="Senmarck Energiespeichersystem Logo">
        <img class="locher" src="img/locher-energie-logo.svg" alt="Locher Energiespeichersystem Logo">
    </nav>
